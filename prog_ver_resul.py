...
from auxiliar_train import leer_datos_text, retocar
...
while salir not in ['out', 'salir', 'exit', 'irse', 'ir']:
    ...
    if nhoa in ['v', 'video', 'Video']:
        ...
        image_label_nomb = []
        for ruta, subdirs, ficheros in os.walk('C:/Users/Sergio.Coteron/Desktop/mark_s/'):
        ...
        larutbelle = 'C:/Users/Sergio.Coteron/Desktop/mark_s/'
        segunda_ruta = ruta_dada[len(larutbelle):]
        for i in range(100):
            if "\\" in segunda_ruta:
                segunda_ruta = segunda_ruta[segunda_ruta.index('\\'):]
            else:
                break
        ...
        nombre_video_guarda = 'analizados_videos' + segunda_ruta[:segunda_ruta.index('.')] + '.avi'
        ...
        while True:
            if (cap.isOpened()== False):
                ...
                try:
                    ...
                    frame_adaptado, lista_absurda = retocar(self, frame, [])
        ...
        print('          --> Ruta guay: /home/sergio/Escritorio/python/Deep learning/Modelos de visión/Reconocimiento de matrículas/dataset/imageTrain')
        print('          --> Ruta guay: /home/sergio/Escritorio/python/Deep learning/Modelos de visión/Reconocimiento de matrículas/dataset/imageTrain/papa')
        print('          --> Ruta guay: /home/sergio/Escritorio/python/Deep learning/Modelos de visión/Reconocimiento de matrículas/dataset/imageTrain/fotostraanjopapa')
        print('')
        print('============================================================================')
        ...
        if os.path.exists(ruta_dada):
            ...
            for i in range(longi):
                ...
                frame_adaptado, lista_absurda = retocar(self,cv2.imread(image_label_nomb[i]),[])
                frame_norm = (frame_adaptado/255)*2 - 1
